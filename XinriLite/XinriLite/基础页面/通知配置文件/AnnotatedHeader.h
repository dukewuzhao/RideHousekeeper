...
#define KNotification_BindingNewBLEKEY @"KNotification_BindingNewBLEKEY"//配置新版蓝牙钥匙
...
#define KNotification_SupportableAccessories @"KNotification_SupportableAccessories"//获取设备可支持配件
