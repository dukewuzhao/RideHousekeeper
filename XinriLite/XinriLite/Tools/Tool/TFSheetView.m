...
- (void)initContent
{
    ...
    if (_contentView == nil)
    {
        _contentView = [[UIView alloc]initWithFrame:CGRectMake(0, ScreenHeight - 90 - QGJ_TabbarSafeBottomMargin, ScreenWidth, 90 + QGJ_TabbarSafeBottomMargin)];
...
- (void)showInView:(UIView *)view
{
    ...
    [_contentView setFrame:CGRectMake(0, ScreenHeight, ScreenWidth, 90 + QGJ_TabbarSafeBottomMargin)];
    
    UIImageView *manImg = [[UIImageView alloc] initWithFrame:CGRectMake(ScreenWidth/2 - 32.5, 10, 25, 25)];
    manImg.image = [UIImage imageNamed:@"man_icon"];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        [_contentView setFrame:CGRectMake(0, ScreenHeight - 90 - QGJ_TabbarSafeBottomMargin, ScreenWidth, 90 + QGJ_TabbarSafeBottomMargin)];
