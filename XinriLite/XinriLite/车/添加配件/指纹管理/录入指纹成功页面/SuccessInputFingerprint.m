...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        successLab.text = NSLocalizedString(@"fingerpring_into_success", nil);
        ...
        printSuc.text = NSLocalizedString(@"fingerpring_set_success", nil);
        printSuc.textColor = [UIColor whiteColor];
        ...
        @weakify(self);
        UIButton *inputNext = [[UIButton alloc] initWithFrame:CGRectMake(ScreenWidth/2 - 100, ScreenHeight- navHeight - 140, 220, 35)];
        [inputNext setTitle:NSLocalizedString(@"fingerpring_next_new", nil) forState:UIControlStateNormal];
        [inputNext setTitleColor:[QFTools colorWithHexString:NSLocalizedString(@"VCControlColor", nil)] forState:UIControlStateNormal];
...
//        [inputNext setAttributedTitle:str forState:UIControlStateNormal];
        ...
        [successBtn setTitle:NSLocalizedString(@"over", nil) forState:UIControlStateNormal];
        ...
        successBtn.backgroundColor = [QFTools colorWithHexString:NSLocalizedString(@"VCControlColor", nil)];
