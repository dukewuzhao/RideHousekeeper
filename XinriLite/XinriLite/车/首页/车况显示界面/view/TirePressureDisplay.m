...
-(void)setNumberWheels:(NSInteger)numberWheels{
    ...
    if (numberWheels == 0) {
        ...
        [self.firstWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(self.firstWheelImg.mas_top).offset(-20);
        }];
        ...
        [self.secondWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(self.mas_centerX);
            make.size.mas_equalTo(CGSizeMake(50, 45));
            make.top.equalTo(self.secondWheelImg.mas_bottom).offset(20);
        }];
        ...
        [self.secondWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.size.mas_equalTo(CGSizeMake(50, 45));
            make.right.equalTo(self.secondWheelImg.mas_left).offset(-20);
        ...
        [self.thirdWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.thirdWheelImg.mas_right).offset(20);
        ...
        [self addSubview:self.firstWheelView];
        [self.firstWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.firstWheelImg.mas_left).offset(-20);
            make.bottom.equalTo(self.firstWheelImg.mas_top).offset(-20);
            make.size.mas_equalTo(CGSizeMake(50, 45));
        }];
        ...
        [self addSubview:self.secondWheelView];
        [self.secondWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.secondWheelImg.mas_right).offset(20);
            make.bottom.equalTo(self.secondWheelImg.mas_top).offset(-20);
            make.size.mas_equalTo(CGSizeMake(50, 45));
        }];
        ...
        [self addSubview:self.thirdWheelView];
        [self.thirdWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.thirdWheelImg.mas_left).offset(-20);
            make.top.equalTo(self.thirdWheelImg.mas_bottom).offset(20);
            make.size.mas_equalTo(CGSizeMake(50, 45));
        }];
        ...
        [self.fourthWheelView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.fourthWheelImg.mas_right).offset(20);
            make.top.equalTo(self.fourthWheelImg.mas_bottom).offset(20);
            make.size.mas_equalTo(CGSizeMake(50, 45));
        }];
        [self setupLineView:numberWheels];
    }
...
-(UILabel *)titlelab{
    ...
    if (!_titlelab) {
        ...
        _titlelab.textColor = [QFTools colorWithHexString:MainColor];
    }
    return _titlelab;
}
