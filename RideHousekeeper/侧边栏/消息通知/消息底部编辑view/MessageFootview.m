...
- (void)showInView:(UIView *)view
{
    ...
    allSelect.backgroundColor = [QFTools colorWithHexString:MainColor];
    ...
    [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(0.8, 35));
    }];
    ...
    allDelete.backgroundColor = [QFTools colorWithHexString:MainColor];
