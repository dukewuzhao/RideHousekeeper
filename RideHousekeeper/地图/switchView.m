...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.layer setBorderWidth:2]; //边框宽框
        self.layer.borderColor = [[QFTools colorWithHexString:@"#F5F5F5"] CGColor];
    }
    return self;
}
...
- (void)btnClick:(HCButton *)button
{
    ...
    self.selectBtn.backgroundColor = [QFTools colorWithHexString:@"#F5F5F5"];
    self.selectBtn.titleLabel.textColor = [QFTools colorWithHexString:@"#666666"];
    button.selected = YES;
