...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        [backview addSubview:_operationLab];
        
        UIImageView *fingerarrow = [[UIImageView alloc] initWithFrame:CGRectMake(self.width *.58, CGRectGetMaxY(_operationLab.frame)+ScreenHeight * 0.06, self.width*.24, self.width*.024)];
        fingerarrow.image = [UIImage imageNamed:@"Indicator_arrow"];
        [backview addSubview:fingerarrow];
        
        UIImageView *fingerBg = [[UIImageView alloc] initWithFrame:CGRectMake(ScreenWidth*.2, CGRectGetMaxY(_operationLab.frame)+ScreenHeight * 0.06, ScreenWidth*.477, ScreenWidth*.477)];
