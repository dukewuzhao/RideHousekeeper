...
@class PressureLockModel;
@class JPushDataModel;
@class PerpheraServicesInfoModel;
@class PeripheralActivationStatusModel;
...
// 插入是否开启胎压监测数据 automaticlock_models
+ (BOOL)insertPressureLockModel:(PressureLockModel *)model;

// 插入jpush推送数据 JPushData_models
