...
- (void)setupPhFieldView
    {
        ...
        phView.backgroundColor = CellColor;
...
- (void)setupFieldView
    {
        ...
        compseView.backgroundColor = [UIColor clearColor];
