...
@property (nonatomic,copy) void(^action)(YBPopupMenu *ybPopupMenu,NSInteger index);
...
+ (YBPopupMenu *)showAtPoint:(CGPoint)point
               ...
               otherSettings:(void (^) (YBPopupMenu * popupMenu))otherSetting action:(void(^)(YBPopupMenu *ybPopupMenu,NSInteger index))action;
