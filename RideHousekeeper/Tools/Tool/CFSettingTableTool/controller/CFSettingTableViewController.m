...
- (void)viewDidLoad {
    ...
    // 设置tableView的背景颜色
    _table = [[UITableView alloc] initWithFrame:CGRectMake(0, navHeight, ScreenWidth, ScreenHeight - navHeight) style:UITableViewStyleGrouped];
    _table.dataSource = self;
    _table.delegate = self;
    //table.bounces = NO;
    // 设置tableView的背景颜色
    //_table.backgroundView = nil;
    _table.backgroundColor = [UIColor colorWithWhite:1 alpha:0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = self.leftLabelFontColor?: CFRightLabelTextColor;
    cell.textLabel.font = self.leftLabelFont? :FONT_PINGFAN(17);
    // 设置参数
