...
//    if ([self isKindOfClass:NSClassFromString(@"XYSideViewController")]) {
//        return self.sideViewController.currentNavController.topViewController.shouldAutorotate;
//    }
...
//    if ([self isKindOfClass:NSClassFromString(@"XYSideViewController")]) {
//        return [self.sideViewController.currentNavController.topViewController supportedInterfaceOrientations];
//    }
