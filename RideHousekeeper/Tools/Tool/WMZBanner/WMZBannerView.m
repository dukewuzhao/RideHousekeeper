...
- (void)setUp{
    ...
    self.bannerControl = [[WMZBannerControl alloc]initWithFrame:CGRectMake(0, self.param.wItemSize.height-20, self.param.wItemSize.width, 10) WithModel:self.param];
